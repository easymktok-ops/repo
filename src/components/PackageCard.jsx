...
const FACES = {
  ...
  biggrin: '<path d="M20 31 q5 -4.5 10 0" stroke="#1D1D1D" stroke-width="2.6" fill="none" stroke-linecap="round"/><path d="M34 31 q5 -4.5 10 0" stroke="#1D1D1D" stroke-width="2.6" fill="none" stroke-linecap="round"/><path d="M21 36 q11 13 22 0 Z" fill="#1D1D1D"/><path d="M47 16 l.9 2 2.1 .2 -1.6 1.4 .5 2.1 -1.9 -1.1 -1.9 1.1 .5 -2.1 -1.6 -1.4 2.1 -.2Z" fill="#FFE066"/>',
